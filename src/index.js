...
const { isMobile, canScreenshare, getUrlParams, addUrlParams } = require("./browser");
...
const conferenceEvents = {
    ...
    ExistingParticipantsReportingComplete: "ExistingParticipantsReportingComplete",
...
const TwilioVideoConferenceEngine = function () {
        ...
        return new Promise((resolve, reject) => {
            Video.connect(accessToken, connectOptions)
                .then(room => {
                    ...
                    notifyOfEvent(conferenceEvents.ExistingParticipantsReportingComplete, room);
                    ...
                    room.once("disconnected",
                        (error) => {
                            ...
                            if(!error)
                                notifyOfEvent(conferenceEvents.RoomCompleted, room);
                            else
                                notifyOfEvent(conferenceEvents.ErrorOccured, error);
                        });
    ...
    const registerCallbacks = (
        ...
        return {
            ...
            onRoomDisconnected: room => {
                if (typeof onRoomDisconnected !== "undefined")
                    onRoomDisconnected(room);
            },
            ...
            onErrorOccured: error => {
                if (typeof onErrorOccured !== "undefined")
                    onErrorOccured(error);
            }
        };
    };
    ...
    const turnOffMyVideo = () => {
        ...
        if (localVideoTracks.length) {
            ...
            if (localVideoTrack) {
                ...
                //Force fire
                trackUnsubscribed({ track: { kind: MediaType.Video }, participant: currentRoom.localParticipant });
    ...
    const turnOffMyAudio = () => {
        ...
        if (localAudioTracks.length) {
            ...
            if (localAudioTrack) {
                ...
                //This event is not fired by default for a local participant 
                //Force fire
                trackUnsubscribed({ track: { kind: MediaType.Audio }, participant: currentRoom.localParticipant });
            }
        }
    ...
    const leaveRoom = roomName => {
        ...
        notifyOfEvent(conferenceEvents.ParticipantDisconnected, currentRoom.localParticipant);
